...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchApplications = async () => {
      ...
      try {
        ...
        // Sort newest first in JS instead of Firestore orderBy
        list.sort((a, b) => {
  ...
  const statusStyles = (status: string) => {
    ...
    return "bg-sky-50 text-sky-700 border-sky-200"; // pending / default
  };
                ...
                >
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3 text-[11px] text-slate-500">
                      ...
                      {app.timeline && (
                        <span>Timeline: {app.timeline}</span>
                      )}
                      {app.clientEmail && (
                        <span>Client: {app.clientEmail}</span>
                      )}
                      {app.createdAt && (
                        <span>
